            ...
            <div class="relative rounded-2xl bg-white dark:bg-gray-900 shadow-2xl shadow-gray-200/50 dark:shadow-none ring-1 ring-gray-200/60 dark:ring-gray-700/60 overflow-hidden">
                ...
                <div class="p-6 sm:p-8">
                    ...
                    <form @submit.prevent="submit" class="space-y-5">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <Link
                                ...
                                class="text-sm font-medium text-brand-600 hover:text-brand-500 dark:text-brand-400 dark:hover:text-brand-300 transition-colors"
                            >
                                Forgot password?
                            </Link>
                        </div>
                    ...
                    <p class="mt-6 text-center text-sm text-gray-500 dark:text-gray-400">
                        ...
                        <Link :href="route('register')" class="font-semibold text-brand-600 hover:text-brand-500 dark:text-brand-400 dark:hover:text-brand-300 transition-colors ml-1">
                            Create one free
                        </Link>
                    </p>
                </div>
