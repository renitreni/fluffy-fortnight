...
<template>
    <GuestLayout>
        ...
        <template #nav-action>
            ...
            <Link
                :href="route('login')"
                class="inline-flex items-center justify-center rounded-lg border border-gray-200 dark:border-gray-700 px-5 py-2 text-sm font-semibold text-gray-700 dark:text-gray-200 transition-all duration-300 hover:border-brand-300 hover:text-brand-600 dark:hover:border-brand-700 dark:hover:text-brand-400"
            >
                Sign in
            </Link>
        </template>
            ...
            <div class="relative rounded-2xl bg-white dark:bg-gray-900 shadow-2xl shadow-gray-200/50 dark:shadow-none ring-1 ring-gray-200/60 dark:ring-gray-700/60 overflow-hidden">
                ...
                <div class="p-6 sm:p-8">
                    ...
                    <div class="text-center mb-8">
                        ...
                        <h1 class="text-2xl font-bold text-gray-900 dark:text-white tracking-tight">Create your account</h1>
                    ...
                    <!-- Social Login -->
                    <div class="mt-6">
                        <a :href="route('oauth.redirect', 'google')" class="flex w-full items-center justify-center gap-3 rounded-xl bg-white dark:bg-gray-800 px-4 py-3 text-sm font-semibold text-gray-700 dark:text-gray-200 shadow-sm ring-1 ring-inset ring-gray-200 dark:ring-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-all duration-200">
